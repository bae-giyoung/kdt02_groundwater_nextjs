...
- (Security Update) React RSC 취약점 모니터링:
    - 2025-12-07: Next.js v15.5.7, React v19.1.2
    - 2025-12-12: Next.js v15.5.9, React v19.1.4
...
| **스타일링** | [Tailwind CSS] | 유틸리티 우선 CSS 프레임워크로, HTML을 벗어나지 않고도 빠르고 일관된 UI 개발을 위해 사용했습니다. |
...
| v1.1.0 | 예정 | csrf 토큰 설정으로 세션 로그인 보안 강화(백엔드 소스 + 프론트엔드 소스) |
